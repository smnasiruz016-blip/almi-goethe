...
const RAW_ITEMS: ExamItemInput[] = [
  ...
  item(
    ...
    "Liebe Mieterinnen und Mieter,\n\nfür die Gemeinschaftsräume im Erdgeschoss gelten ab sofort klare Regeln. Wer einen Raum nutzen möchte, trägt sich bitte vorher in die (1) am schwarzen Brett ein. Die Räume stehen werktags bis zweiundzwanzig Uhr zur (2). Nach der Nutzung ist jeder für die (3) selbst zuständig; Geschirr gehört gespült in den Schrank zurück. Auf die Nachbarn ist besonders am Abend (4) zu nehmen. Wer Möbel umstellt, bringt sie anschließend an den ursprünglichen (5) zurück. Schäden melden Sie bitte umgehend der (6). Für private Feiern ist eine schriftliche (7) erforderlich. Die Schlüssel werden gegen eine (8) ausgegeben, die Sie bei der Rückgabe zurückerhalten. Zigaretten sind in allen Räumen (9). Wir hoffen auf ein rücksichtsvolles (10).",
    ["Liste", "Verfügung", "Reinigung", "Rücksicht", "Platz", "Verwaltung", "Erlaubnis", "Kaution", "verboten", "Miteinander", "Ladung", "Ernte", "Werbung", "gemessen", "Auswahl"],
    ["Liste", "Verfügung", "Reinigung", "Rücksicht", "Platz", "Verwaltung", "Erlaubnis", "Kaution", "verboten", "Miteinander"],
  ),
