// AlmiGoethe-branded header — own wordmark + the family sibling nav + product entry
...
// The family strip for this repo = every product except AlmiGoethe (its own brand
// wordmark is Goethe's home) + the network links. Sourced from the canonical list.
export const FAMILY_NAV = familyStrip("goethe");

// Product entry points into AlmiGoethe's own practice product.
