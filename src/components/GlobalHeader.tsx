// AlmiGoethe-branded header — own wordmark + product entry points + the family
// sibling nav (like AlmiCV's site header). The brand links home; the family
// links keep AlmiGoethe connected to the rest of AlmiWorld.
...
// take a visitor from any page into AlmiGoethe's own practice product.
